...
describe("DateRangePicker component", () => {
  it("renders with default props", () => {
    ...
    expect(container.querySelector(".date-range-picker-container")).toBeInTheDocument();
  ...
  it("applies custom className", () => {
    ...
    expect(container.querySelector(".date-range-picker-container")).toHaveClass("custom-class");
  });
  ...
  it("accepts and displays initial date range", () => {
    ...
    expect(screen.getByTestId("date-range-text").textContent).toContain("03/01/2025 - 03/15/2025");
  });
  ...
  it("accepts ISO date format strings", () => {
    ...
    expect(screen.getByTestId("date-range-text").textContent).toContain("03/12/2025 - 04/12/2025");
  });
  ...
  it("shows correct month and year in calendar header", () => {
    ...
    expect(screen.getByTestId("calendar-month-year").textContent).toBe("May 2025");
  });
 ...
 it("navigates to previous year when previous year button is clicked", () => {
    ...
    expect(screen.getByTestId("calendar-month-year").textContent).toBe("March 2024");
  });
