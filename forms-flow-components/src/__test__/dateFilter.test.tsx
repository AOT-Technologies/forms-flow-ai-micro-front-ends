...
jest.mock("../components/SvgIcons", () => ({
  ...
  AngleRightIcon: () => (
    <div data-testid="angle-right-icon">AngleRightIcon</div>
  ),
...
describe("DateRangePicker Component", () => {
  ...
  it("renders with default placeholder when no dates are selected", () => {
    ...
    expect(screen.getByTestId("date-range-text")).toHaveTextContent(
      "Select date range"
    );
  ...
  it("handles custom date format correctly", () => {
    ...
    expect(screen.getByTestId("date-range-text").textContent).toBe(
  ...
  it("resets to empty range when value prop becomes null/undefined", () => {
    ...
    rerender(<DateRangePicker onChange={mockOnChange} value={undefined} />);
  ...
  it("renders weekday headers correctly", () => {
    ...
    const weekdayElements = screen
      .getByTestId("calendar-days-header")
      .querySelectorAll(".calendar-weekday");
  ...
  it("applies correct CSS classes to selected date range", () => {
    ...
    render(
      <DateRangePicker onChange={mockOnChange} value={initialDateRange} />
    );
    ...
    const selectedDays = calendarDays.filter((day) =>
    ...
    const startDateDay = calendarDays.find((day) =>
      day.classList.contains("start-date")
    );
    const endDateDay = calendarDays.find((day) =>
      day.classList.contains("end-date")
    );
