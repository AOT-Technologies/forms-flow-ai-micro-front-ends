...
describe("DropdownMultiSelect Component", () => {
  ...
  const renderComponent = (props = {}) =>
    render(<DropdownMultiSelect {...defaultProps} {...props} />);
  ...
  it("renders multiselect when enableMultiSelect is true", () => {
    ...
    expect(
      container.querySelector(".multiSelectContainer")
    ).toBeInTheDocument();
  });
  ...
  it("disables multiselect when disabled prop is true", () => {
    ...
    expect(container.querySelector(".multiSelectContainer")).toHaveClass(
      "disable_ms"
    );
  });
