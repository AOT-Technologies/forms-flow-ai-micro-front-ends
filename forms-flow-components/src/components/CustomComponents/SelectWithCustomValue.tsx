...
const SelectWithCustomValueComponent = forwardRef<
  HTMLDivElement,
...
>(
  (
    ...
    // Shared internal hooks replace the previously copy-pasted
    // portal-position and click-outside effects (identical computation and
    // registration semantics; see src/customHooks/internal/).
    ...
    useClickOutside([dropdownRef, primaryMenuRef, primaryWrapperRef], () => {
      closeDropdownAndClearSearch();
    ...
    const handleCustomInputSetValue = useCallback(
      (newValue: string) => {
...
export type { SelectWithCustomValueProps as SelectWithCustomValuePropsType };
