  ...
  ({
    ...
    const handleRevertClick = (params: any) => {
      ...
      if (
        ...
        (params.processType === "BPMN" ||
          params.processType === "DMN" ||
          params.processType === "LOWCODE")
      ) {
    ...
    const generateColumns = (): GridColDef[] => {
      const columns: GridColDef[] = [
        ...
        },
        {
          ...
          valueGetter: (value, row) =>
            row.publishedOn
              ? HelperServices?.getLocalDateAndTime(row.publishedOn)
              : "-",
        },
        {
          field: "created",
          ...
          align: "left",
          valueGetter: (value, row) =>
            HelperServices?.getLocalDateAndTime(row.created),
        },
        {
          field: "createdBy",
