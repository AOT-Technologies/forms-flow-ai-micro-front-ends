  ...
  return (
    <div style={{ width: "500px" }}>
      ...
      >
        ...
        <div>
          <strong>Tip:</strong> Press Enter to submit search
        </div>
      </div>
    </div>
  );
...
export const LongPlaceholder: Story = {
  args: {
    placeholder:
      "Enter your search query to find relevant information across all available resources",
...
export const EnterKeySearch: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Type in the search box and press Enter to trigger the search. The search will be logged to the Actions panel.",
      },
    },
  },
};
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Use the controls to adjust props and observe behavior. Try different placeholder texts, disabled states, and search values. Press Enter to submit searches.",
      },
    },
  },
};
