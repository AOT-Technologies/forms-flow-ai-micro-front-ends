...
const CustomTextInputTemplate = (args: any) => {
  ...
  return (
    <div style={{ width: "500px" }}>
      <CustomTextInput {...args} value={value} setValue={handleValueChange} />
    </div>
  );
};
...
export const LongPlaceholder: Story = {
  args: {
    placeholder:
      "Enter a very long description or detailed information about your request",
...
export const FormField: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Example of text input in a form context with proper accessibility labels.",
      },
    },
  },
};
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Use the controls to adjust props and observe behavior. Try different placeholder texts, disabled states, and ARIA labels.",
      },
    },
  },
};
