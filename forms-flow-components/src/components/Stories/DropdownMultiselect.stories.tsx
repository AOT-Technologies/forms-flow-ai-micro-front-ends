...
const meta: Meta<typeof DropdownMultiSelect> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A combined dropdown and multi-select component that allows single selection from a dropdown and optional multiple selections. Supports primary/secondary variants and provides flexible configuration options.",
      },
    },
  },
  tags: ["autodocs"],
        ...
        >
          ...
          {selectedItems.length > 0 && (
            <div style={{ marginTop: "8px" }}>
              <strong>Multi-Select Items:</strong>{" "}
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Use the controls panel below to experiment with all component properties and see how they affect the behavior and appearance.",
      },
    },
  },
};
