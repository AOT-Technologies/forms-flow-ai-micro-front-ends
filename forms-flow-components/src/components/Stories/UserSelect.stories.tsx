...
const UserSelectTemplate = (args: any) => {
  ...
  return (
    <div style={{ minHeight: "300px", padding: "20px" }}>
      <UserSelect {...args} value={selectedValue} onChange={handleChange} />
    </div>
  );
};
...
const meta: Meta<typeof UserSelect> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A specialized dropdown component for selecting users from a list. Built on SelectDropdown with user-specific features like name formatting, email display, and smart sorting. Includes "Assign to me" and "Unassigned" special options.',
      },
    },
  },
  tags: ["autodocs"],
...
export const WithEmailLabels: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Displays email addresses alongside user names in the dropdown for easier identification.",
      },
    },
  },
};
...
export const ShowAsText: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Displays as plain text that converts to a dropdown when hovered, focused, or clicked. Useful for inline editing scenarios.",
      },
    },
  },
};
...
export const ManyUsers: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "User select with a large list of users. Users are automatically sorted alphabetically by name.",
      },
    },
  },
};
...
export const ManyUsersWithEmail: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Large user list with email addresses displayed. Searchable dropdown helps find users quickly.",
      },
    },
  },
};
...
export const UsersWithoutNames: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Handles users who only have usernames (no first/last name). Falls back to displaying username.",
      },
    },
  },
};
...
export const UsersWithPartialNames: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates smart name formatting for users with only first name, only last name, or neither.",
      },
    },
  },
};
...
export const EmptyUserList: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Shows only the special options ("Assign to me" and "Unassigned") when no users are provided.',
      },
    },
  },
};
...
export const ShowAsTextWithHover: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Inline text mode - hover over the name to activate the dropdown for editing.",
      },
    },
  },
};
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Use the controls panel below to experiment with all UserSelect properties and see how they affect the component.",
      },
    },
  },
};
