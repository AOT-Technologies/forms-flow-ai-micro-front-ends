...
const meta: Meta<typeof V8CustomButton> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A versatile, accessible button component with multiple variants, states, and size options. Built with TypeScript, React.memo, and forwardRef for optimal performance and composability.",
      },
    },
  },
  tags: ["autodocs"],
...
export const ErrorState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Error variant for destructive actions like delete, remove, or cancel operations.",
      },
    },
  },
};
...
export const Warning: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Warning variant for actions that require user attention or caution before proceeding.",
      },
    },
  },
};
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Use the controls panel below to experiment with all button properties and see how they affect the component.",
      },
    },
  },
};
