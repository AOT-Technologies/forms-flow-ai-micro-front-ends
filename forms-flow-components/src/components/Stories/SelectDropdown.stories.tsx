...
const SelectDropdownTemplate = (args: any) => {
  ...
  return (
    <div style={{ width: "300px", minHeight: "200px" }}>
      <SelectDropdown {...args} value={selectedValue} onChange={handleChange} />
      {selectedValue && (
        <div
          style={{
            marginTop: "20px",
...
export const SearchNoResults: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Try searching for "orange" to see the "No Matching Results" state.',
      },
    },
  },
};
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Use the controls panel below to experiment with all dropdown properties and see how they affect the component.",
      },
    },
  },
};
