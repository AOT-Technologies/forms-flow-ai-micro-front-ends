...
import { getCustomSubmission } from "../api/services/applicationService";
...
import { 
  ...
  getProcessDetails,
} from "../api/services/processServices";
const ViewApplication = React.memo(() => {
  ...
  const submission = useSelector((state: any) => state.submission?.submission || {});
  ...
  //check
 const markers = useSelector((state: any) => state.process?.processActivityList);
