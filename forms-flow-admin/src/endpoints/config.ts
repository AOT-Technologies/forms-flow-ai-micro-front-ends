...
export const KEYCLOAK_URL_HTTP_RELATIVE_PATH =
  env?.REACT_APP_KEYCLOAK_URL_HTTP_RELATIVE_PATH ?? "/auth";
export const KEYCLOAK_URL_AUTH = `${
  KEYCLOAK_URL ?? ""
}${KEYCLOAK_URL_HTTP_RELATIVE_PATH}`;
...
export const MT_ADMIN_BASE_URL_VERSION =
  env?.REACT_APP_MT_ADMIN_BASE_URL_VERSION ?? "v1";
