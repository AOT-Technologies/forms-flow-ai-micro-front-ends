...
export const NavbarBundlesIcon = makeStub("NavbarBundlesIcon");
export const NavbarDecisionTablesIcon = makeStub("NavbarDecisionTablesIcon");
export const NavbarFormsIcon = makeStub("NavbarFormsIcon");
export const NavbarHomeIcon = makeStub("NavbarHomeIcon");
export const NavbarManageIcon = makeStub("NavbarManageIcon");
export const NavbarSubflowsIcon = makeStub("NavbarSubflowsIcon");
export const NavbarSubmissionsIcon = makeStub("NavbarSubmissionsIcon");
export const NavbarSubmitIcon = makeStub("NavbarSubmitIcon");
export const NavbarTaskIcon = makeStub("NavbarTaskIcon");
export const NavbarUserIcon = makeStub("NavbarUserIcon");
