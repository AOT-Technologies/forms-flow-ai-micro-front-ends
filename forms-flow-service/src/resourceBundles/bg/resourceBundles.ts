...
export const RESOURCE_BUNDLES_BG = {
  ...
  "Specific role": "Специфична роля",
  "Specific assignee": "Специфичен изпълнител",
  "Oldest to Newest": "От най-старо към най-ново",
  "Newest to Oldest": "От най-ново към най-старо",
  "A to Z": "От A до Z",
  "Z to A": "От Z до A",
  "Largest to Smallest": "От най-голямо към най-малко",
  "Smallest to Largest": "От най-малко към най-голямо",
  "Nobody(Keep it private)": "Никой (Запази го частно)",
  "Everybody": "Всички",
  "Toggle the visibility of columns and re-order them if needed.": "Превключване на видимостта на колоните и тяхното подреждане при нужда",
  "Default Sort": "Стандартно сортиране",
  "How Many Line of Data To Show Per Row?": "Колко реда данни да се показват на ред?",
  "line of data dropdown": "Падащо меню за редове данни",
  "line of data input": "Вход за редове данни",
  "Share This Filter With": "Сподели този филтър с",
  "filter sharing dropdown": "Падащо меню за споделяне на филтър",
  "Save This Filter": "Запази този филтър",
  "Save Task Filter": "Запази филтър за задачи",
  "Parameters": "Параметри",
  "create filter modal title": "Заглавие на модалния прозорец за създаване на филтър",
  "Tasks: Unsaved Filter": "Задачи: Несъздаден филтър",
  ...
  "Re-order And Hide Filters": "Пренареждане и скриване на филтри",
  "No filter selected.": "Няма избран филтър.",
  "Assigned To": "Възложено на",
  "column": "колона",
  "sortable": "сортируема",
  "No tasks have been found. Try a different filter combination or contact your admin.": "Не са намерени задачи. Опитайте с друга комбинация от филтри или се свържете с вашия администратор.",
  "unnamed": "без име",
  "Unassigned": "Неназначено",
  "N/A": "Няма данни",
  "Tasks data table with resizable columns": "Таблица с данни за задачи с променлив размер на колоните",
  "Resizable tasks table container": "Контейнер на таблица за задачи с променлив размер",
  "Task table container": "Контейнер на таблица за задачи",
  "Table outer container": "Външен контейнер на таблица",
  "Scrollable task table content": "Съдържание на таблица със задачи с възможност за превъртане",
  "Inner table container": "Вътрешен контейнер на таблица",
  "Table footer container": "Контейнер на долната част на таблицата",
  "Table pagination controls": "Контроли за страниране на таблицата",
  "Select number of tasks per page": "Избор на брой задачи на страница",
  "Navigate between task pages": "Навигация между страниците със задачи",
  "No tasks message": "Съобщение за липса на задачи",
  "No filter selected message": "Съобщение за неизбран филтър",
  "Select business filter": "Избор на бизнес филтър",
  "Edit selected filter": "Редактиране на избрания филтър",
  "Select attribute filter": "Избор на филтър по атрибути",
  "Edit attribute filters": "Редактиране на филтри по атрибути",
  "Select date range for filtering": "Избор на диапазон от дати за филтриране",
  "Start date": "Начална дата",
  "End date": "Крайна дата",
  "Toggle Create Filter Modal": "Превключване на модал за създаване на филтър",
  "Filter the task list": "Филтриране на списъка със задачи",
  "Refresh the task list": "Обновяване на списъка със задачи",
  "Modal for sorting tasks": "Модал за сортиране на задачи",
  "Select date range": "Изберете период",
  "Date range selector": "Избор на период",
  "Close calendar": "Затвори календара",
  ...
  "This filter is created and managed by you": "Този филтър е създаден и управляван от вас",
  "Column widths are saved within a filter. If you wish to adjust them. Click Filter Results, adjust the widths of the columns in the table until you are happy and then save the filter afterwards.": "Широчините на колоните се запазват в рамките на филтър. Ако искате да ги коригирате, кликнете върху Резултати от филтъра, регулирайте широчините на колоните в таблицата, докато сте доволни, и след това запазете филтъра.",
  "This filter is created and managed by {{createdBy}}": "Този филтър е създаден и управляван от {{createdBy}}",
  "Update This Filter": "Актуализирайте този филтър",
  "Delete This Filter": "Изтрийте този филтър",
  "Delete This Filter?": "Изтриване на този филтър?",
  "This filter is shared with others. Deleting this filter will delete it for everybody and might affect their workflow.": "Този филтър е споделен с други. Изтриването на този филтър ще го изтрие за всички и може да повлияе на техния работен процес.",
  "No, Keep This Filter": "Не, запазете този филтър",
  "Yes, Delete This Filter For Everybody": "Да, изтрийте този филтър за всички",
