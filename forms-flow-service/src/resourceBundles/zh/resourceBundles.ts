...
export const RESOURCE_BUNDLES_ZH = {
  ...
  "You have made changes that are not saved yet. The unsaved changes could be either on the Layout or the Flow side.": "您已进行更改，但尚未保存。未保存的更改可能在布局或流程部分。",
  "Note": "注意",
  ...
  "Import": "导入",
  "Allowing the addition of multiple pages in a single form will prevent you from using this form in a bundle later.": "允许在单个表单中添加多个页面将阻止您稍后在捆绑中使用此表单。",
  ...
  "Making changes to your form URL will make your form inaccessible from your current URL.": "对表单 URL 的更改将使您的表单无法通过当前 URL 访问。",
  "Save Your Changes": "保存您的更改",
  "Saving as an incremental version will affect previous submissions. Saving as a new full version will not affect previous submissions.": "保存为增量版本将影响以前的提交。保存为新的完整版本将不会影响以前的提交。",
  "Save as Version": "保存为版本",
  "Discard Layout Changes?": "放弃布局更改？",
  "Are you sure you want to discard all the changes to the layout of the form?": "您确定要放弃表单布局的所有更改吗？",
  ...
  "To use variables in the flow, as well as sorting by them in the submissions and tasks you need to specify which variables you want to import from the layout. Variables get imported into the system at the time of the submission, if the variables that are needed are not selected prior to the form submission THEY WILL NOT BE AVAILABLE in the flow, submissions, and tasks.": "要在流程中使用变量，并在提交和任务中按其排序，您需要指定要从布局中导入的变量。变量会在提交时导入到系统中，如果在表单提交之前没有选择所需的变量，它们将无法在流程、提交和任务中使用。",
  ...
  "Are you sure you want to discard all unsaved changes to the flow of the form?": "您确定要放弃表单流程的所有未保存更改吗？",
  "Yes, Discard All Unsaved Changes": "是的，放弃所有未保存的更改",
  "No, Keep The Changes": "不，保留更改",
  "Import File": "导入文件",
  "Click or drag a file to this area to import (form, layout or bpmn)": "单击或拖动文件到此区域以导入（表单、布局或 BPMN）",
  "Support for a single .json, .bpmn file upload. Maximum file size 20MB.": "支持单个 .json 或 .bpmn 文件上传。最大文件大小为 20MB。",
...
"Importing and deleting is not available when the form is published. You must unpublish the form first if you wish to make any changes.": "当表单已发布时，无法导入和删除。如果您希望进行任何更改，必须先取消发布表单。",
  ...
  "For further customization, please provide specifications.": "如需进一步自定义，请提供详细说明.",
  "Regenerate": "重新生成",
  "Start Over": "重新开始",
  "Undo": "撤销",
  "I am Flow-E.": "我是 Flow-E。",
  "I can help you design forms effortlessly. I will build out the fields and layout for you, which you can further customize or you can": "我可以帮助您轻松设计表单。我将为您构建字段和布局，您可以进一步自定义，或者您可以",
  ...
  "Are you sure you want to duplicate the current BPMN?": "您确定要复制当前 BPMN 吗？",
  "Yes, Duplicate This BPMN": "是的，复制此 BPMN",
  "No, Do Not Duplicate This BPMN": "不，不要复制此 BPMN",
  "Export BPMN": "导出 BPMN",
  "Publish This BPMN": "发布此 BPMN",
  "Are you sure you want to duplicate the current DMN?": "您确定要复制当前 DMN 吗？",
  "Yes, Duplicate This DMN": "是的，复制此 DMN",
  "No, Do Not Duplicate This DMN": "不，不要复制此 DMN",
  "Publish This DMN": "发布此 DMN",
  "Publishing will lock the {{type}}. To save changes on further edits, you will need to unpublish the {{type}} first.": "发布将锁定{{type}}. 若要在以后编辑中保存更改，您需要先取消发布{{type}}.",
  "Unpublish and Edit This BPMN": "取消发布并编辑此 BPMN",
  "Cancel, Keep This BPMN published": "取消，保持此 BPMN 已发布",
  "This {{type}} is currently live. To save changes to {{type}} edits, you need to unpublish it first.": "此 {{type}} 当前处于在线状态。要保存对 {{type}} 编辑的更改，您需要先取消发布它.",
  "Importing is not available when the {{type}} is published. You must unpublish the {{type}} first if you wish to make any changes.": "当 {{type}} 已发布时，无法进行导入. 若要进行任何更改，您必须先取消发布 {{type}}.",
  "Unpublish and Edit This DMN": "取消发布并编辑此 DMN",
  "Cancel, Keep This DMN published": "取消，保持此 DMN 发布",
  "You Cannot Delete This Form": "您无法删除此表单",
  "But you may unpublish it if you wish to not receive any more submissions.": "但如果您不想再接收任何提交，可以取消发布此表单。",
  "You may not delete a form that has submissions associated with it.": "您不能删除已关联提交的表单。",
  ...
  "Sends or gets data from an integration through a recipe (workato)": "通过配方（Workato）发送或获取集成数据",
  "Action: Use Integration Modal": "操作：使用集成模式",
  "Recipe": "配方",
  "Exclude Fields": "排除字段",
  "Create task": "创建任务",
  "Creates a task for a specific user or a user role": "为特定用户或用户角色创建任务",
  ...
  "(or) Evaluates true if value on the left OR on the right is not empty": "(或) 如果左侧或右侧的值不为空，则计算为真",
  "(and) Evaluates true if value on the left AND on the right is not empty": "(和) 如果左侧和右侧的值都不为空，则计算为真",
  "(less than) Evaluates true if the value on the left is less than value on the right": "(小于) 如果左侧的值小于右侧的值，则计算为真",
  "(larger than) Evaluates true if the value on the left is larger than value on the right": "(大于) 如果左侧的值大于右侧的值，则计算为真",
  "(less than or equal) Evaluates true if the value on the left is less than or equal to the value on the right": "(小于或等于) 如果左侧的值小于或等于右侧的值，则计算为真",
  "(larger than or equal) Evaluates true if the value on the left is larger than or equal to the value on the right": "(大于或等于) 如果左侧的值大于或等于右侧的值，则计算为真",
  "(equals) Evaluates true if the value on the left is equal to the value on the right": "(等于) 如果左侧的值等于右侧的值，则计算为真",
  "(contains) Evaluates true if text contains some specified text (not case sensitive)": "(包含) 如果文本包含某些指定文本（不区分大小写），则计算为真",
  ...
  "If you delete this node , you won't be able to undo this action. Are you sure you want to proceed?": "如果删除此节点，您将无法 撤销此操作。您确定要继续吗？",
  ...
  "This will copy the flow from Version 1.1 overwriting your existing flow.": "这将从 1.1 版本复制流程，并覆盖您现有的流程。",
  ...
  "Everybody": "所有人",
  "Toggle the visibility of columns and re-order them if needed.": "切换列的可见性并在需要时重新排序。",
  "Default Sort": "默认排序",
  ...
  "Filter Results": "筛选结果",
  "Cancel filter": "取消筛选器",
  "Filter name should be less than {{filterNameLength}} characters": "过滤器名称应少于{{filterNameLength}}个字符",
  ...
  "column": "列",
  "sortable": "可排序",
  "No tasks have been found. Try a different filter combination or contact your admin.": "未找到任务。尝试使用不同的筛选器组合或联系您的管理员。",
  "unnamed": "未命名",
  "Unassigned": "未分配",
  "N/A": "不适用",
  ...
  "Column widths are saved within a filter. If you wish to adjust them. Click Filter Results, adjust the widths of the columns in the table until you are happy and then save the filter afterwards.": "列宽度保存在筛选器中。如果您希望调整它们，请单击筛选结果，调整表格中列的宽度，直到您满意，然后保存筛选器。",
  "This filter is created and managed by {{createdBy}}": "此筛选器由{{createdBy}}创建和管理",
  "Update This Filter": "更新此筛选器",
  "Delete This Filter": "删除此筛选器",
  "Delete This Filter?": "删除此筛选器？",
  "This filter is shared with others. Deleting this filter will delete it for everybody and might affect their workflow.": "此筛选器与他人共享。删除此筛选器将删除所有人的筛选器，并可能影响他们的工作流程。",
  ...
  "No forms have been found. Create a new form by clicking the \"New Form & Flow\" button in the top right.": "未找到表单。请点击右上角的“新表单和流程”按钮创建新表单。",
   "Current user": "当前用户",
  "Field selection is not available for bundles at this time.": "目前无法为捆绑包选择字段。",
