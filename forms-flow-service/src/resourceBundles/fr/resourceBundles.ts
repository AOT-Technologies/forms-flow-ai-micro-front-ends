...
export const RESOURCE_BUNDLES_FR = {
  ...
  "For Variable, ignore case of": "Pour la variable, ignore la commande Case Of",
  "value": "valeur",
  ...
  "Groups": "groupes",
  "Click to Change Assignee": "Cliquez pour modifier la personne assignée",
  "Reset Assignee": "Réinitialiser la personne assignée",
  ...
  "Bundle deleted successfully": "Groupe supprimé avec succès",
  ...
  "Create Bundle": "Créer un groupe",
  "Rows per page": "Lignes par page",
  "Items per page": "Éléments par page",
  "entries": "entrées",
  "Form Bundle": "Groupe de formulaires",
  "No bundles found": "Aucun groupe trouvé",
  "Please change the selected filters to view Bundles": "Veuillez modifier les filtres sélectionnés pour afficher les groupes",
  ...
  "Bundle Description": "Description du groupe",
  ...
  "Publish this Bundle for Client Users.": "Publier ce groupe pour les utilisateurs clients",
  ...
  "Application Permission": "Autorisation de l'application",
  ...
  "Bundle Name and Description is Required": "Nom du groupe et description requis",
  "Bundle Description is Required": "Description du groupe requise",
  "Bundle Create Successfully": "Groupe créé avec succès",
  "Bundle updated successfully": "Groupe mis à jour avec succès",
  "Select": "choisir",
  ...
  "Back to Bundle List": "Retour à la liste des groupes",
  "Bundle": "Groupe",
  ...
  "Search by bundle name": "Rechercher par nom de groupe",
  "Save Bundle": "Enregistrer groupe",
  "Id": "Id",
  "Enable bundling ?": "Activer le regroupement ?",
  "Select a task in the List.": "Sélectionnez une tâche dans la liste.",
  ...
  "To add a tooltip to this field, enter text here.": "Pour ajouter un infobulle à ce champ, saisissez du texte ici.",
  ...
  "Raw (Insecure)": "Brute (non sécurisé)",
  "Protected": "protégé",
  ...
  "Calculate Value on server": "Calculer la valeur sur le serveur",
  ...
  "Secret Validation": "Validation secrète",
  ...
  "Schema Defenition": "définition du schéma",
  ...
  "Disable Clear Icon": "Désactiver l'icône d'effacement",
  ...
  "Clone Row Components": "Composants clonage de ligne",
  "Check this if you would like to": "Vérifiez ceci si vous le souhaitez",
  "Cell Alignment": "alignement des cellules",
  "Horizontal alignment for cells of the table.": "Alignement horizontal des cellules du tableau.",
  "Center": "centre",
  "Striped": "Rayé",
  "This will stripe the table if checked.": "Si cette case est cochée, cela va rayer le tableau.",
  "Bordered": "en bordure",
  ...
  "Save as reference": "Enregistrer comme référence",
  ...
  "Size": "Taille",
  "Drop files to attach,": "Déposez vos fichiers pour les attacher,",
  "browse": "parcourir",
  "or":"ou"
}
