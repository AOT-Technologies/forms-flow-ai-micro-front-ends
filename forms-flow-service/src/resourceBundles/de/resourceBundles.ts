...
export const RESOURCE_BUNDLES_DE = {
  "Unpublish This Form & Flow": "Dieses Formular und diesen Flow unveröffentlicht machen",
  "Dismiss": "Schließen",
  ...
  "Create Form, workflow designs": "Formular erstellen, Workflow-Designs",
  "Access to design": "Zugang zum Design",
  "Create submissions": "Einreichungen erstellen",
  "Access to submissions": "Zugriff auf Einreichungen",
  "Access to dashboards": "Zugriff auf Dashboards",
  "Access to tasks": "Zugriff auf Aufgaben",
  "Can claim and work on tasks": "Kann Aufgaben annehmen und bearbeiten",
  "Manage all filters": "Alle Filter verwalten",
  "Access to create filters": "Zugriff auf Filter erstellen",
  "Access to view filters": "Zugriff auf Filter anzeigen",
  "Access to Integrations": "Zugriff auf Integrationen",
  "Manage Dashboard Authorization": "Dashboard-Autorisierung verwalten",
  ...
  "By unpublishing this form & flow, you will make it unavailable for new submissions.": "Durch das Aufheben der Veröffentlichung dieses Formulars und Flows machen Sie es für neue Einsendungen unzugänglich.",
  ...
  "Cancel, Keep This Form & Flow Published": "Abbrechen, dieses Formular und diesen Flow veröffentlicht lassen",
  ...
  "build new form with AI": "Neues Formular mit KI erstellen",
  "Flow-E": "Flow-E",
  "Message Flow-E": "Nachricht an Flow-E",
  "Select this Layout": "Dieses Layout auswählen",
  "Your form is now ready": "Ihr Formular ist jetzt bereit",
  "For further customization, please provide specifications.": "Für weitere Anpassungen geben Sie bitte Spezifikationen an.",
  "Regenerate": "Neu generieren",
  "Start Over": "Von vorne anfangen",
  "Undo": "Rückgängig machen",
  "I am Flow-E.": "Ich bin Flow-E.",
  "I can help you design forms effortlessly. I will build out the fields and layout for you, which you can further customize or you can": "Ich kann Ihnen helfen, Formulare mühelos zu entwerfen. Ich werde die Felder und das Layout für Sie erstellen, die Sie weiter anpassen können, oder Sie können",
  "Try an Example Prompt": "Probieren Sie eine Beispielaufforderung aus",
  "Select Template For New Form": "Vorlage für neues Formular auswählen",
  "Select This Template": "Wählen Sie diese Vorlage",
  "form": "Formular",
  "flow": "Fluss",
  "all templates": "Alle Vorlagen",
  "Nothing is found. Please try again.": "Nichts gefunden. Bitte versuche es erneut.",
  "Search ...": "Suche ...",
  "Use AI": "KI verwenden",
  "Build form using Flow-E AI chatbot": "Formular mit dem Flow-E KI-Chatbot erstellen",
  "Start off from a template": "Mit einer Vorlage beginnen",
  "Export Failed": "Export fehlgeschlagen",
  "Create Duplicate": "Duplikat erstellen",
  "Are you sure you want to duplicate the current BPMN?": "Sind Sie sicher, dass Sie das aktuelle BPMN duplizieren möchten?",
  "Yes, Duplicate This BPMN": "Ja, dieses BPMN duplizieren",
  "No, Do Not Duplicate This BPMN": "Nein, dieses BPMN nicht duplizieren",
  "Export BPMN": "BPMN exportieren",
  "Publish This BPMN": "Veröffentlichen Sie dieses BPMN",
  "Are you sure you want to duplicate the current DMN?": "Sind Sie sicher, dass Sie das aktuelle DMN duplizieren möchten?",
  "Yes, Duplicate This DMN": "Ja, dieses DMN duplizieren",
  "No, Do Not Duplicate This DMN": "Nein, dieses DMN nicht duplizieren",
  "Publish This DMN": "Veröffentlichen Sie dieses DMN",
  "Publishing will lock the {{type}}. To save changes on further edits, you will need to unpublish the {{type}} first.": "Die Veröffentlichung wird das {{type}} sperren. Um Änderungen bei weiteren Bearbeitungen zu speichern, müssen Sie das {{type}} zuerst unveröffentlichen.",
  "Unpublish and Edit This BPMN": "Veröffentlichung aufheben und dieses BPMN bearbeiten",
  "Cancel, Keep This BPMN published": "Abbrechen, dieses BPMN veröffentlicht lassen",
  "This {{type}} is currently live. To save changes to {{type}} edits, you need to unpublish it first.": "Dieses {{type}} ist derzeit live. Um Änderungen an {{type}}-Bearbeitungen zu speichern, müssen Sie es zuerst veröffentlichen.",
  "Unpublish and Edit This DMN": "De-publizieren und dieses DMN bearbeiten",
  "Cancel, Keep This DMN published": "Abbrechen, dieses DMN veröffentlicht lassen",
  "You Cannot Delete This Form": "Sie können dieses Formular nicht löschen",
  "But you may unpublish it if you wish to not receive any more submissions.": "Aber Sie können es zurückziehen, wenn Sie keine weiteren Einsendungen mehr erhalten möchten.",
  "You may not delete a form that has submissions associated with it.": "Sie können ein Formular, das mit Einsendungen verknüpft ist, nicht löschen.",
  "Keep This Form": "Dieses Formular behalten",
  "Unpublish This Form": "Dieses Formular de-publizieren",
  "A system error occurred during export. Please try again.": "Beim Export ist ein Systemfehler aufgetreten. Bitte versuchen Sie es erneut.",
  "Try Again": "Versuche es erneut",
  "No forms have been found. Create a new form by clicking the \"New Form\" button in the top right.": "Keine Formulare gefunden. Erstellen Sie ein neues Formular, indem Sie auf die Schaltfläche 'Neues Formular' oben rechts klicken.",
  "No subflows have been found. Create a new subflow by clicking \"New BPMN\" button in the top right.": "Keine Subflows gefunden. Erstellen Sie einen neuen Subflow, indem Sie auf die Schaltfläche 'Neues BPMN' oben rechts klicken.",
  "No decision tables have been found. Create a new decision table by clicking \"New DMN\" button in the top right.": "Keine Entscheidungstabellen gefunden. Erstellen Sie eine neue Entscheidungstabelle, indem Sie auf die Schaltfläche 'Neues DMN' oben rechts klicken.",
  "Form Submitted": "Formular eingereicht",
  "Sample form submitted": "Beispielformular eingereicht",
  "Type of Block to Add": "Art des hinzuzufügenden Blocks",
  "Blocks that do something": "Blöcke, die etwas tun",
  "Condition": "Bedingung",
  "Decision making expression": "Entscheidungsausdruck",
  "Send email": "E-Mail senden",
  "Sends a pre-defined email": "Sendet eine vordefinierte E-Mail",
  "Action: send Email": "Aktion: E-Mail senden",
  "Recipient": "Empfänger",
  "Subject": "Betreff",
  "Body": "Text",
  "Select a Variable": "Variable auswählen",
  "Search Available Variable": "Verfügbare Variable suchen",
  "More Variables from Form’s Layout": "Weitere Variablen aus dem Formularlayout",
  "Use This Variable": "Diese Variable verwenden",
  "Use integration": "Integration verwenden",
  "Sends or gets data from an integration through a recipe (workato)": "Sendet oder erhält Daten aus einer Integration über ein Rezept (Workato)",
  "Action: Use Integration Modal": "Aktion: Integrationsmodal verwenden",
  "Recipe": "Rezept",
  "Exclude Fields": "Felder ausschließen",
  "Create task": "Aufgabe erstellen",
  "Creates a task for a specific user or a user role": "Erstellt eine Aufgabe für einen bestimmten Benutzer oder eine Benutzerrolle",
  "Action: Create Task": "Aktion: Aufgabe erstellen",
  "Create a task for": "Erstelle eine Aufgabe für",
  "Specific Roles": "Spezifische Rollen",
  "Set/update variable value": "Variablenwert setzen/aktualisieren",
  "Assigns value to a specified variable": "Weist einer angegebenen Variablen einen Wert zu",
  "Action: Set/Update Variable Value": "Aktion: Variablenwert setzen/aktualisieren",
  "Variable to update": "Zu aktualisierende Variable",
  "New value for the variable": "Neuer Wert für die Variable",
  "Variable to update is required.": "Eine zu aktualisierende Variable ist erforderlich.",
  "Action Name is required": "Aktionsname ist erforderlich",
  "Action Name is required.": "Aktionsname ist erforderlich.",
  "New value for the variable is required.": "Ein neuer Wert für die Variable ist erforderlich.",
  "Condition Name": "Bedingungsname",
  "Expression": "Ausdruck",
  "Expression Builder": "Ausdrucksersteller",
  "Condition Name is required": "Bedingungsname ist erforderlich",
  "Pick Variable": "Variable auswählen",
  "Form variable": "Formularvariable",
  "Custom Value": "Benutzerdefinierter Wert",
  "Empty Expression": "Leerer Ausdruck",
  "Search Form Variable": "Formularvariable suchen",
  "Set Value": "Wert festlegen",
  "Enter Custom Value": "Benutzerdefinierten Wert eingeben",
  "Pick An Operator": "Einen Operator auswählen",
  "(add) Adds values together": "(addieren) Addiert Werte zusammen",
  "(subtract) Subtracts values": "(subtrahieren) Subtrahiert Werte",
  "(divide) Divides values": "(teilen) Teilt Werte",
  "(multiply) Multiplies values": "(multiplizieren) Multipliziert Werte",
  "(or) Evaluates true if value on the left OR on the right is not empty": "(oder) Ergibt wahr, wenn der Wert links ODER rechts nicht leer ist",
  "(and) Evaluates true if value on the left AND on the right is not empty": "(und) Ergibt wahr, wenn die Werte links UND rechts nicht leer sind",
  "(less than) Evaluates true if the value on the left is less than value on the right": "(kleiner als) Ergibt wahr, wenn der Wert links kleiner als der rechts ist",
  "(larger than) Evaluates true if the value on the left is larger than value on the right": "(größer als) Ergibt wahr, wenn der Wert links größer als der rechts ist",
  "(less than or equal) Evaluates true if the value on the left is less than or equal to the value on the right": "(kleiner oder gleich) Ergibt wahr, wenn der Wert links kleiner oder gleich dem Wert rechts ist",
  "(larger than or equal) Evaluates true if the value on the left is larger than or equal to the value on the right": "(größer oder gleich) Ergibt wahr, wenn der Wert links größer oder gleich dem Wert rechts ist",
  "(equals) Evaluates true if the value on the left is equal to the value on the right": "(gleich) Ergibt wahr, wenn der Wert links gleich dem Wert rechts ist",
  "(contains) Evaluates true if text contains some specified text (not case sensitive)": "(enthält) Ergibt wahr, wenn der Text eine bestimmte Zeichenfolge enthält (nicht groß-/klein-schreibungssensitiv)",
  "Add your condition": "Fügen Sie Ihre Bedingung hinzu",
  "Are you sure you want to Delete the Node ?": "Sind Sie sicher, dass Sie den Knoten löschen möchten?",
  "If you delete this node , you won't be able to undo this action. Are you sure you want to proceed?": "Wenn Sie diesen Knoten löschen, können Sie diese Aktion nicht rückgängig machen. Sind Sie sicher, dass Sie fortfahren möchten?",
  "No, Keep This Node": "Nein, behalten Sie diesen Knoten",
  "Yes, Delete the Node": "Ja, löschen Sie den Knoten",
  "Recipient is required.": "Empfänger ist erforderlich.",
  "Switch to BPMN ": "Zu BPMN wechseln",
  "Switch to Bpmn": "Zu BPMN wechseln",
  "Keep Editing My Flow in No-Code": "Bearbeiten meines Flows in No-Code fortsetzen",
  "Pick No-code version": "No-Code-Version auswählen",
  "Return to No-code": "Zurück zu No-Code",
  "Delete All Changes and Pick No-Code Version": "Alle Änderungen löschen und No-Code-Version wählen",
  "Stay in BPMN": "In BPMN bleiben",
  "This will copy the flow from Version 1.1 overwriting your existing flow.": "Dies kopiert den Flow aus Version 1.1 und überschreibt Ihren vorhandenen Flow.",
  "Use Flow from Version 1.1": "Flow aus Version 1.1 verwenden",
  "Keep Current Flow": "Aktuellen Flow behalten",
  ...
  "Specific role": "Spezifische Rolle",
  "Specific assignee": "Spezifischer Zuweisender",
  "Oldest to Newest": "Älteste zuerst",
  "Newest to Oldest": "Neueste zuerst",
  "A to Z": "A bis Z",
  "Z to A": "Z bis A",
  "Largest to Smallest": "Größtes zu Kleinster",
  "Smallest to Largest": "Kleinster zu Größtes",
  "Nobody(Keep it private)": "Niemand (Privat halten)",
  "Everybody": "Jeder",
  "Toggle the visibility of columns and re-order them if needed.": "Schalten Sie die Sichtbarkeit der Spalten um und ordnen Sie sie bei Bedarf neu an.",
  "Default Sort": "Standard-Sortierung",
  "How Many Line of Data To Show Per Row?": "Wie viele Datenzeilen pro Zeile anzeigen?",
  "line of data dropdown": "Dropdown für Datenzeilen",
  "line of data input": "Eingabe der Datenzeile",
  "Share This Filter With": "Teilen Sie diesen Filter mit",
  "filter sharing dropdown": "Dropdown zur Filterfreigabe",
  "Save This Filter": "Diesen Filter speichern",
  "Save Task Filter": "Aufgabenfilter speichern",
  "Parameters": "Parameter",
  "create filter modal title": "Titel des Filtermoduls erstellen",
  "Tasks: Unsaved Filter": "Aufgaben: Ungespeicherter Filter",
  "Filter Tabs": "Filter-Tabs",
  "Filter Results": "Filterergebnisse",
  "Cancel filter": "Filter abbrechen",
  "Filter name should be less than {{filterNameLength}} characters": "Der Filtername sollte weniger als {{filterNameLength}} Zeichen enthalten",
  "Tasks Accessible To": "Aufgaben zugänglich für",
  "dropdown for selecting options": "Dropdown zur Auswahl von Optionen",
  "input for typing option": "Eingabe zum Tippen der Option",
  "specific role dropdown": "Dropdown für spezifische Rolle",
  "specific role input": "Eingabe für spezifische Rolle",
  "assignee dropdown": "Dropdown für zugewiesene Person",
  "assignee input": "Eingabe für zugewiesene Person",
  "dropdown for sort options": "Dropdown für Sortieroptionen",
  "candidate dropdown": "Dropdown für Kandidaten",
  "candidate input": "Eingabe für Kandidaten",
  "dropdown_for_sort_order": "Dropdown für Sortierreihenfolge",
  "input_for_sort_order": "Eingabe für Sortierreihenfolge",
  ...
  "Re-order And Hide Filters": "Filter neu anordnen und ausblenden",
  "No filter selected.": "Kein Filter ausgewählt.",
  "Assigned To": "Zugewiesen an",
  "column": "Spalte",
  "sortable": "sortierbar",
  "No tasks have been found. Try a different filter combination or contact your admin.": "Keine Aufgaben gefunden. Versuchen Sie eine andere Filterkombination oder wenden Sie sich an Ihren Administrator.",
  "unnamed": "unbenannt",
  "Unassigned": "Nicht zugewiesen",
  "N/A": "N/A",
  "Tasks data table with resizable columns": "Aufgabendatentabelle mit größenveränderbaren Spalten",
  "Resizable tasks table container": "Container für größenveränderbare Aufgabentabelle",
  "Task table container": "Aufgabentabellencontainer",
  "Table outer container": "Äußerer Tabellencontainer",
  "Scrollable task table content": "Scrollbarer Aufgabentabelleninhalt",
  "Inner table container": "Innerer Tabellencontainer",
  "Table footer container": "Tabellenfußzeilencontainer",
  "Table pagination controls": "Tabellenseitenumbruchsteuerung",
  "Select number of tasks per page": "Anzahl der Aufgaben pro Seite auswählen",
  "Navigate between task pages": "Zwischen Aufgabenseiten navigieren",
  "No tasks message": "Keine Aufgaben Nachricht",
  "No filter selected message": "Nachricht bei keinem ausgewählten Filter",
  "Select business filter": "Geschäftsfilter auswählen",
  "Edit selected filter": "Ausgewählten Filter bearbeiten",
  "Select attribute filter": "Attributfilter auswählen",
  "Edit attribute filters": "Attributfilter bearbeiten",
  "Select date range for filtering": "Datumsbereich für Filterung auswählen",
  "Start date": "Startdatum",
  "End date": "Enddatum",
  "Toggle Create Filter Modal": "Modalfenster zum Erstellen von Filtern umschalten",
  "Filter the task list": "Aufgabenliste filtern",
  "Refresh the task list": "Aufgabenliste aktualisieren",
  "Modal for sorting tasks": "Modal zum Sortieren von Aufgaben",
  "Select date range": "Datumsbereich auswählen",
  "Date range selector": "Datumsbereichsauswahl",
  ...
  "Field selection is not available for bundles at this time.": "Die Feldauswahl ist für Bundles derzeit nicht verfügbar.",
  "Owner and specific roles": "Eigentümer und bestimmte Rollen",
  "Only owner": "Nur Eigentümer"
}
