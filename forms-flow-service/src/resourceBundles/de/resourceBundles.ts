...
export const RESOURCE_BUNDLES_DE = {
  "Unpublish This Form & Flow":
    "Dieses Formular und diesen Flow unveröffentlicht machen",
  Dismiss: "Schließen",
  "You Cannot Delete This Form & Flow":
    "Sie können dieses Formular und diesen Ablauf nicht löschen.",
  "You cannot delete a form & flow that has submissions associated with it.":
    "Sie können ein Formular und einen Ablauf mit zugehörigen Einreichungen nicht löschen.",
  ...
  "Show only current user assigned task":
    "Nur zugewiesene Aufgaben des aktuellen Benutzers anzeigen",
  "Show task based on logged user roles":
    "Aufgaben basierend auf den Rollen des angemeldeten Benutzers anzeigen",
  ...
  "Only selected task attributes will be available on task list view":
    "Nur ausgewählte Aufgabenattribute sind in der Aufgabenliste sichtbar",
  ...
  "Unfinished submissions will be saved to Submissions/Drafts.":
    "Unvollständige Einreichungen werden in Einreichungen/Entwürfe gespeichert.",
  ...
  "Access restricted by its designer..!":
    "Zugriff durch den Designer eingeschränkt..!",
  "and you will no longer have the access to this form in bundles":
    "und Sie haben keinen Zugriff mehr auf dieses Formular in Bündeln",
  "You will no longer have the access to this form in bundles":
    "Sie haben keinen Zugriff mehr auf dieses Formular in Bündel",
  "Bad Request": "Ungültige Anforderung",
  "Select the form to be displayed based on the  above criteria":
    "Wählen Sie das anzuzeigende Formular basierend auf den oben genannten Kriterien aus.",
  "Create the criteria using the API key of any form component and a conditional notation. For example, 'age > 18' where 'age' is the API key of a form component":
    "Erstellen Sie die Kriterien unter Verwendung des API-Schlüssels eines beliebigen Formularkomponenten und einer bedingten Notation. Zum Beispiel 'age > 18', wobei 'age' der API-Schlüssel eines Formularkomponenten ist.",
  "Select form version": "Formularversion auswählen",
  "Please remove the special characters...!":
    "Bitte entfernen Sie die Sonderzeichen...!",
  ...
  "This will create a new version of the form without changing the path name but with new form id.":
    "Dadurch wird eine neue Version des Formulars erstellt, ohne den Pfadnamen zu ändern, aber mit einer neuen Formular-ID.",
  ...
  "Do you want to save a new version of this form?":
    "Möchten Sie eine neue Version dieses Formulars speichern?",
  "Do you want to create a duplicate form and associated workflow from existing form ?":
    "Möchten Sie ein Duplikat des Formulars und des zugehörigen Workflows aus einem vorhandenen Formular erstellen?",
  ...
  "Formsflow automatically saves your previous form data. Now you can switch to the previous stage and edit.":
    "Formsflow speichert automatisch Ihre vorherigen Formulardaten. Jetzt können Sie zur vorherigen Stufe wechseln und bearbeiten.",
  ...
  "Unfinished applications will be saved to Applications/Drafts.":
    " Unfertige Bewerbungen werden unter Bewerbungen/Entwürfe gespeichert.",
  "Discard Draft": "Entwurf verwerfen",
  "with ID": "mit ID",
  "Please change the selected filters to view Forms":
    "Bitte ändern Sie die ausgewählten Filter, um Formulare anzuzeigen",
  ...
  "Please change the selected filters to view applications":
    "Wijzig de geselecteerde filters om applicaties te bekijken",
  ...
  "Please select an existing workflow.":
    "Bitte wählen Sie einen bestehenden Workflow aus.",
  "Create New": "Neu erstellen",
  "Or create new workflow or import a workflow from a local directory.":
    "Oder erstellen Sie einen neuen Workflow oder importieren Sie einen Workflow aus einem lokalen Verzeichnis.",
  "The operation couldn't be completed. Please try after sometime":
    "Der Vorgang konnte nicht abgeschlossen werden. Bitte versuchen Sie es nach einiger Zeit erneut",
  "Select...": "Auswählen...",
  ...
  "You can't submit this form until it is published":
    "Sie können dieses Formular erst absenden, wenn es veröffentlicht wurde",
  "Form not published": "Formular nicht veröffentlicht",
  "Access Denied": "Zugriff abgelehnt",
  "By default, the tenant key would be prefixed to form":
    "Standardmäßig wird dem Mandantenschlüssel form vorangestellt",
  "go back": "zurück",
  "No Applications Found": "Keine Anwendungen gefunden",
  ...
  "Error in creating form process mapper":
    "Fehler beim Erstellen des Formularprozess-Mappers",
  ...
  "Duplicate form created successfully":
    "Doppeltes Formular erfolgreich erstellt",
  Revert: "Zurückkehren",
  Overview: "Überblick",
  ...
  "Applicable for Designer Roled Users only.":
    "Gilt nur für Benutzer mit Designer-Rolle.",
  "Applicable for Client and Reviewer Roled Users only.":
    "Gilt nur für Benutzer mit Kunden- und Prüferrollen.",
  Criteria: "Kriterien",
  ...
  "Please change the selected filters to view Bundles":
    "Bitte ändern Sie die ausgewählten Filter, um Bundles anzuzeigen",
  "Select all to download forms":
    "Wählen Sie alle aus, um Formulare herunterzuladen",
  ...
  "You can change the form order by drag and drop":
    "Sie können die Formularreihenfolge per Drag and Drop ändern",
  ...
  "Form bundles can save your time by grouping forms together":
    "Formularbündel können Ihre Zeit sparen, indem Sie Formulare gruppieren",
  ...
  "Publish this Bundle for Client Users.":
    "Veröffentlichen Sie dieses Bundle für Client-Benutzer",
  ...
  "Bundle Name and Description is Required":
    "Paketname und -beschreibung sind erforderlich",
  ...
  "Are you sure deleting the role":
    "Sind Sie sicher, dass Sie die Rolle löschen",
  ...
  "Search by name, username or email":
    "Suche nach Name, Benutzername oder E-Mail",
  ...
  "Role names cannot contain special characters except   _ , -":
    "Rollennamen dürfen keine Sonderzeichen außer _ , - enthalten.",
  "Role names cannot contain special characters except _ , - , / ":
    "Rollennamen dürfen keine Sonderzeichen außer _ , - , / enthalten.",
  ...
  "Explore our Template Library to find the perfect combination of forms and workflows. Click to preview a template and, if it fits your needs, customize it to your liking. Once you've tailored it to your specific requirements, you're all set to create your business case":
    "Erkunden Sie unsere Vorlagenbibliothek, um die perfekte Kombination aus Formularen und Workflows zu finden. Klicken Sie auf eine Vorlage, um eine Vorschau anzuzeigen, und passen Sie sie nach Ihren Wünschen an. Sobald Sie sie an Ihre speziellen Anforderungen angepasst haben, sind Sie bereit, Ihr Geschäftsszenario zu erstellen",
  ...
  "Permission for submission tracking.":
    "Berechtigung für die Einreichungsverfolgung.",
  "Reviewer permission to view submissions":
    "Berechtigung des Reviewers zur Ansicht von Einreichungen",
  "Permission to create new submission":
    "Berechtigung zur Erstellung einer neuen Einreichung",
  "Back to Bundle List": "Zurück zur Bündelliste",
  Bundle: "Bündel",
  "You can drag these nodes to the pane on the right.":
    "Sie können diese Knoten auf das Fenster rechts ziehen.",
  "You can delete the element by select and click the backspace":
    "Sie können das Element auswählen und die Rücktaste drücken, um es zu löschen",
  ...
  "Choose this option when you want to create a fresh workflow based on the template. System will generate and deploy a new workflow, then connect it to the selected form. Opt for this if your form requires a distinct set of workflow steps tailored to its specific needs.":
    "Wählen Sie diese Option aus, wenn Sie einen neuen Workflow auf der Grundlage der Vorlage erstellen möchten. Das System generiert und implementiert einen neuen Workflow und verbindet ihn dann mit dem ausgewählten Formular. Entscheiden Sie sich dafür, wenn Ihr Formular eine speziell auf seine Bedürfnisse zugeschnittene Reihe von Workflow-Schritten erfordert.",
  ...
  "Select this option to link the form with an already established workflow. Any modifications made to the existing workflow will automatically reflect in this form as well. This is ideal when you want to leverage the existing workflow for your form's requirements.":
    "Wählen Sie diese Option aus, um das Formular mit einem bereits etablierten Workflow zu verknüpfen. Alle Änderungen am vorhandenen Workflow werden sich automatisch auch in diesem Formular widerspiegeln. Dies ist ideal, wenn Sie den vorhandenen Workflow für die Anforderungen Ihres Formulars nutzen möchten.",
  ...
  "I can help you design forms effortlessly- all you have to do is give me a clear and concise description of what the form is meant to do. I will build out the fields and layout for you,which you can further customize.":
    "Ich kann Ihnen helfen, Formulare mühelos zu gestalten - alles, was Sie tun müssen, ist mir eine klare und prägnante Beschreibung dessen zu geben, wofür das Formular gedacht ist. Ich werde die Felder und das Layout für Sie erstellen, die Sie weiter anpassen können.",
  "I am": "Ich bin",
  "For example 'Give us a form that will serve as a patient intake form for walk-in clinics'":
    "Zum Beispiel 'Geben Sie uns ein Formular, das als Anmeldeformular für Patienten in Walk-In-Kliniken dient'.",
  ...
  "I'm here to provide further assistance. Thank you!":
    "Ich stehe Ihnen gerne für weitere Unterstützung zur Verfügung. Vielen Dank!",
  ...
  "Please tell me all the specifications and requirements you have in mind for your form. After you have finished the description, hit send.":
    "Bitte geben Sie uns alle Spezifikationen und Anforderungen, die Sie für Ihr Formular im Kopf haben. Nachdem Sie die Beschreibung abgeschlossen haben, drücken Sie die Eingabetaste.",
  ...
  "Choose a task from the list; your selection directs your current activity.":
    "Wählen Sie eine Aufgabe aus der Liste aus; Ihre Auswahl bestimmt Ihre aktuelle Aktivität.",
  "Please change the selected filters to view submissions":
    "Bitte ändern Sie die ausgewählten Filter, um Einreichungen anzuzeigen",
  "Please change the selected filters to view drafts":
    "Bitte ändern Sie die ausgewählten Filter, um Entwürfe anzuzeigen",
  "No drafts found": "Keine Entwürfe gefunden",
  ...
  "Flow-E is not available for demonstration in the trial instance. You can experience Flow-E in any of the premium packages of the product":
    "Flow-E steht in der Testinstanz nicht für eine Demonstration zur Verfügung. Sie können Flow-E in einem der Premium-Pakete des Produkts erleben",
  "Get in touch with formsflow.ai team":
    "Kontaktieren Sie das formsflow.ai-Team",
  Premium: "Premium",
  ...
  "Display authorized tasks based on user roles":
    "Autorisierte Aufgaben basierend auf Benutzerrollen anzeigen",
  "You are currently using a test instance.The trial period ends in":
    "Sie verwenden derzeit eine Testinstanz. Die Testphase endet in",
  "days.": "Tage.",
  ...
  "Click here to select attributes":
    "Klicken Sie hier, um Attribute auszuwählen",
  "Select the predefined attributes and custom task variables created as part of form submission you wish to display in the task list":
    "Wählen Sie die vordefinierten Attribute und benutzerdefinierten Aufgabenvariablen aus, die im Rahmen der Formularübermittlung erstellt wurden und die Sie in der Aufgabenliste anzeigen möchten",
  ...
  "To display task variables, select a form as part of the filter":
    "Um Aufgabenvaiablen anzuzeigen, wählen Sie ein Formular als Teil des Filters aus",
  ...
  "Select form fields to display in task list":
    "Wählen Sie die Formularfelder aus, die in der Aufgabenliste angezeigt werden sollen",
  ...
  "Selecting all form fields may affect performance. For the best performance, just pick the form fields you really need.":
    "Das Auswählen aller Formularfelder kann sich auf die Leistung auswirken. Wählen Sie für die beste Leistung nur die Formularfelder aus, die Sie wirklich benötigen.",
  ...
  " For further insights on this exclusive premium feature, kindly connect":
    "Für weitere Einblicke in dieses exklusive Premium-Feature, verbinden Sie sich bitte",
  " with our dedicated marketing team for detailed information.":
    "mit unserem engagierten Marketingteam für detaillierte Informationen.",
  ...
  "We facilitate hundreds of native integrations via our ‘Native Integrations Pro’ package.":
    "Wir ermöglichen Hunderte von nativen Integrationen über unser Paket „Native Integrations Pro“.",
  " This feature is not available by default in the 14 day trial. If your trial requires this feature, you can let us know and we can enable this for you.":
    "Diese Funktion ist standardmäßig nicht im 14-Tage-Test verfügbar. Wenn Ihr Test diese Funktion erfordert, können Sie uns dies mitteilen, und wir können dies für Sie aktivieren.",
  "Upgrade to unlock Native Integrations Pro":
    "Upgrade, um Native Integrations Pro freizuschalten",
  "We facilitate hundreds of native integrations via our ":
    "Wir ermöglichen Hunderte von nativen Integrationen über unsere ",
  ...
  " package. This feature is not available by default in the 14 day trial. If your trial requires this feature, you can let us know and we can enable this for you.":
    "-Paket. Diese Funktion ist standardmäßig nicht in der 14-Tage-Testversion verfügbar. Wenn Ihre Testversion diese Funktion erfordert, können Sie uns dies mitteilen, und wir können sie für Sie aktivieren.",
  "To learn more about Native Integrations Pro":
    "Weitere Informationen zu Native Integrations Pro finden Sie unter",
  ...
  "Connect with formsflow.ai team.":
    "Verbinden Sie sich mit dem formsflow.ai-Team.",
  "You don't have permission to access this page.":
    "Sie haben keine Berechtigung, diese Seite zu betreten.",
  "Please contact your administrator or try again later.":
    "Bitte wenden Sie sich an Ihren Administrator oder versuchen Sie es später erneut.",
  ...
  "Are you sure you wish to delete the draft":
    "Möchten Sie den Entwurf wirklich löschen",
  ...
  "Check to disable weekends":
    "Aktivieren Sie diese Option, um Wochendtage zu deaktivieren",
  ...
  "Changing the form workflow will not affect the existing submissions. It will only update in the newly created submissions. Press Save Changes to continue or cancel the changes.":
    "Die Änderung des Formular-Workflows wird die bestehenden Einreichungen nicht beeinflussen. Es wird nur in den neu erstellten Einreichungen aktualisiert. Drücken Sie Speichern Sie die Änderungen, um fortzufahren oder die Änderungen abzubrechen.",
  ...
  "Changing the form title will not affect the existing submissions. It will only update in the newly created submissions. Press Save Changes to continue or cancel the changes.":
    "Die Änderung des Formulartitels wird die bestehenden Einreichungen nicht beeinflussen. Es wird nur in den neu erstellten Einreichungen aktualisiert. Drücken Sie Speichern Sie die Änderungen, um fortzufahren oder die Änderungen abzubrechen.",
  "No submissions Found": "Keine Einreichungen gefunden",
  ...
  "Select a specific task from the provided list of options. Your selection will determine the task you will be working on or interacting with.":
    "Wählen Sie eine bestimmte Aufgabe aus der bereitgestellten Optionsliste aus. Ihre Auswahl bestimmt die Aufgabe, an der Sie arbeiten oder mit der Sie interagieren.",
  ...
  "Contact formsflow.ai support":
    "Kontaktieren Sie den Support von formsflow.ai",
  "Please provide your tenant name to sign in":
    "Bitte geben Sie Ihren Mandantenname zum Anmelden ein",
  ...
  "You have made changes that are not saved yet. The unsaved changes could be either on the Layout or the Flow side.":
    "Sie haben Änderungen vorgenommen, die noch nicht gespeichert sind. Die nicht gespeicherten Änderungen können entweder im Layout oder im Flow erfolgen.",
  Note: "Hinweis",
  "Stay in the Editor": "Im Editor bleiben",
  "Discard Changes and Leave the Page":
    "Änderungen verwerfen und Seite verlassen",
  "By unpublishing this form & flow, you will make it unavailable for new submissions.":
    "Durch das Aufheben der Veröffentlichung dieses Formulars und Flows machen Sie es für neue Einsendungen unzugänglich.",
  ...
  "Publishing will save any unsaved changes and lock the entire form, including the layout and the flow. To perform any additional changes you will need to unpublish the form again.":
    "Das Veröffentlichen speichert alle ungespeicherten Änderungen und sperrt das gesamte Formular, einschließlich Layout und Fluss. Um weitere Änderungen vorzunehmen, müssen Sie das Formular erneut zurückziehen.",
  ...
  "Allowing the addition of multiple pages in a single form will prevent you from using this form in a bundle later.":
    "Das Hinzufügen mehrerer Seiten zu einem einzelnen Formular verhindert, dass Sie dieses Formular später in einem Bundle verwenden können.",
  "Allow adding multiple pages in this form":
    "Hinzufügen mehrerer Seiten in diesem Formular erlauben",
  ...
  "Making changes to your form URL will make your form inaccessible from your current URL.":
    "Änderungen an Ihrer Formular-URL machen Ihr Formular von der aktuellen URL aus unzugänglich.",
  ...
  "Saving as an incremental version will affect previous submissions. Saving as a new full version will not affect previous submissions.":
    "Das Speichern als inkrementelle Version wird frühere Einsendungen beeinflussen. Das Speichern als neue vollständige Version wird frühere Einsendungen nicht beeinflussen.",
  ...
  "Are you sure you want to discard all the changes to the layout of the form?":
    "Sind Sie sicher, dass Sie alle Änderungen am Layout des Formulars verwerfen möchten?",
  ...
  "Variables for Flow, Submissions, and Tasks":
    "Variablen für Fluss, Einsendungen und Aufgaben",
  ...
  "Select a form field on the left":
    "Wählen Sie ein Formularfeld auf der linken Seite aus",
  ...
  "Are you sure you want to discard all unsaved changes to the flow of the form?":
    "Sind Sie sicher, dass Sie alle ungespeicherten Änderungen am Fluss des Formulars verwerfen möchten?",
  "Yes, Discard All Unsaved Changes":
    "Ja, alle ungespeicherten Änderungen verwerfen",
  "No, Keep The Changes": "Nein, die Änderungen behalten",
  "Import File": "Datei importieren",
  "Click or drag a file to this area to import (form, layout or bpmn)":
    "Klicken oder ziehen Sie eine Datei in diesen Bereich, um sie zu importieren (Formular, Layout oder BPMN)",
  "Support for a single .json, .bpmn file upload. Maximum file size 20MB.":
    "Unterstützt das Hochladen einer einzelnen .json- oder .bpmn-Datei. Maximale Dateigröße: 20 MB.",
  ...
  "Importing and deleting is not available when the form is published. You must unpublish the form first if you wish to make any changes.":
    "Importieren und Löschen ist nicht verfügbar, wenn das Formular veröffentlicht ist. Sie müssen das Formular zuerst zurückziehen, wenn Sie Änderungen vornehmen möchten.",
  ...
  "Click or drag a file to this area to import":
    "Klicken oder ziehen Sie eine Datei in diesen Bereich, um sie zu importieren",
  ...
  "For further customization, please provide specifications.":
    "Für weitere Anpassungen geben Sie bitte Spezifikationen an.",
  ...
  "I can help you design forms effortlessly. I will build out the fields and layout for you, which you can further customize or you can":
    "Ich kann Ihnen helfen, Formulare mühelos zu entwerfen. Ich werde die Felder und das Layout für Sie erstellen, die Sie weiter anpassen können, oder Sie können",
  ...
  "Nothing is found. Please try again.":
    "Nichts gefunden. Bitte versuche es erneut.",
  "Search ...": "Suche ...",
  "Use AI": "KI verwenden",
  "Build form using Flow-E AI chatbot":
    "Formular mit dem Flow-E KI-Chatbot erstellen",
  ...
  "Are you sure you want to duplicate the current BPMN?":
    "Sind Sie sicher, dass Sie das aktuelle BPMN duplizieren möchten?",
  ...
  "Are you sure you want to duplicate the current DMN?":
    "Sind Sie sicher, dass Sie das aktuelle DMN duplizieren möchten?",
  ...
  "Publishing will lock the {{type}}. To save changes on further edits, you will need to unpublish the {{type}} first.":
    "Die Veröffentlichung wird das {{type}} sperren. Um Änderungen bei weiteren Bearbeitungen zu speichern, müssen Sie das {{type}} zuerst unveröffentlichen.",
  "Unpublish and Edit This BPMN":
    "Veröffentlichung aufheben und dieses BPMN bearbeiten",
  "Cancel, Keep This BPMN published":
    "Abbrechen, dieses BPMN veröffentlicht lassen",
  "This {{type}} is currently live. To save changes to {{type}} edits, you need to unpublish it first.":
    "Dieses {{type}} ist derzeit live. Um Änderungen an {{type}}-Bearbeitungen zu speichern, müssen Sie es zuerst veröffentlichen.",
  "Unpublish and Edit This DMN": "De-publizieren und dieses DMN bearbeiten",
  "Cancel, Keep This DMN published":
    "Abbrechen, dieses DMN veröffentlicht lassen",
  ...
  "But you may unpublish it if you wish to not receive any more submissions.":
    "Aber Sie können es zurückziehen, wenn Sie keine weiteren Einsendungen mehr erhalten möchten.",
  "You may not delete a form that has submissions associated with it.":
    "Sie können ein Formular, das mit Einsendungen verknüpft ist, nicht löschen.",
  ...
  "A system error occurred during export. Please try again.":
    "Beim Export ist ein Systemfehler aufgetreten. Bitte versuchen Sie es erneut.",
  "Try Again": "Versuche es erneut",
  'No forms have been found. Create a new form by clicking the "New Form" button in the top right.':
    "Keine Formulare gefunden. Erstellen Sie ein neues Formular, indem Sie auf die Schaltfläche 'Neues Formular' oben rechts klicken.",
  'No subflows have been found. Create a new subflow by clicking "New BPMN" button in the top right.':
    "Keine Subflows gefunden. Erstellen Sie einen neuen Subflow, indem Sie auf die Schaltfläche 'Neues BPMN' oben rechts klicken.",
  'No decision tables have been found. Create a new decision table by clicking "New DMN" button in the top right.':
    "Keine Entscheidungstabellen gefunden. Erstellen Sie eine neue Entscheidungstabelle, indem Sie auf die Schaltfläche 'Neues DMN' oben rechts klicken.",
  ...
  "More Variables from Form’s Layout":
    "Weitere Variablen aus dem Formularlayout",
  ...
  "Sends or gets data from an integration through a recipe (workato)":
    "Sendet oder erhält Daten aus einer Integration über ein Rezept (Workato)",
  ...
  "Creates a task for a specific user or a user role":
    "Erstellt eine Aufgabe für einen bestimmten Benutzer oder eine Benutzerrolle",
  ...
  "Assigns value to a specified variable":
    "Weist einer angegebenen Variablen einen Wert zu",
  "Action: Set/Update Variable Value":
    "Aktion: Variablenwert setzen/aktualisieren",
  ...
  "Variable to update is required.":
    "Eine zu aktualisierende Variable ist erforderlich.",
  "Action Name is required": "Aktionsname ist erforderlich",
  "Action Name is required.": "Aktionsname ist erforderlich.",
  "New value for the variable is required.":
    "Ein neuer Wert für die Variable ist erforderlich.",
  ...
  "Keep Editing My Flow in No-Code":
    "Bearbeiten meines Flows in No-Code fortsetzen",
  ...
  "Delete All Changes and Pick No-Code Version":
    "Alle Änderungen löschen und No-Code-Version wählen",
  "Stay in BPMN": "In BPMN bleiben",
  "This will copy the flow from Version 1.1 overwriting your existing flow.":
    "Dies kopiert den Flow aus Version 1.1 und überschreibt Ihren vorhandenen Flow.",
  ...
  "Toggle the visibility of columns and re-order them if needed.":
    "Schalten Sie die Sichtbarkeit der Spalten um und ordnen Sie sie bei Bedarf neu an.",
  "Default Sort": "Standard-Sortierung",
  "How Many Line of Data To Show Per Row?":
    "Wie viele Datenzeilen pro Zeile anzeigen?",
  ...
  "Filter name should be less than {{filterNameLength}} characters":
    "Der Filtername sollte weniger als {{filterNameLength}} Zeichen enthalten",
  ...
  "No tasks have been found. Try a different filter combination or contact your admin.":
    "Keine Aufgaben gefunden. Versuchen Sie eine andere Filterkombination oder wenden Sie sich an Ihren Administrator.",
  unnamed: "unbenannt",
  Unassigned: "Nicht zugewiesen",
  "N/A": "N/A",
  "Tasks data table with resizable columns":
    "Aufgabendatentabelle mit größenveränderbaren Spalten",
  "Resizable tasks table container":
    "Container für größenveränderbare Aufgabentabelle",
  ...
  "Toggle Create Filter Modal":
    "Modalfenster zum Erstellen von Filtern umschalten",
  ...
  "This filter is created and managed by you":
    "Dieser Filter wurde von Ihnen erstellt und wird von Ihnen verwaltet",
  "Column widths are saved within a filter. If you wish to adjust them. Click Filter Results, adjust the widths of the columns in the table until you are happy and then save the filter afterwards.":
    "Spaltenbreiten werden innerhalb eines Filters gespeichert. Wenn Sie diese anpassen möchten, klicken Sie auf Filterergebnisse, passen Sie die Breiten der Spalten in der Tabelle an, bis Sie zufrieden sind, und speichern Sie anschließend den Filter.",
  "This filter is created and managed by {{createdBy}}":
    "Dieser Filter wurde von {{createdBy}} erstellt und wird von {{createdBy}} verwaltet",
  ...
  "This filter is shared with others. Deleting this filter will delete it for everybody and might affect their workflow.":
    "Dieser Filter wird mit anderen geteilt. Das Löschen dieses Filters löscht ihn für alle und könnte ihren Arbeitsablauf beeinträchtigen.",
  ...
  "This filter is shared with others. Updating this filter will update it for everybody and might affect their workflow. Proceed with caution.":
    "Dieser Filter wird mit anderen geteilt. Das Aktualisieren dieses Filters wird ihn für alle aktualisieren und könnte ihren Arbeitsablauf beeinträchtigen. Bitte vorsichtig vorgehen.",
  "No, Cancel Changes": "Nein, Änderungen abbrechen",
  "Yes, Update This Filter For Everybody":
    "Ja, diesen Filter für alle aktualisieren",
  ...
  'No forms have been found. Create a new form by clicking the "New Form & Flow" button in the top right.':
    "Es wurden keine Formulare gefunden. Erstellen Sie ein neues Formular, indem Sie oben rechts auf die Schaltfläche „Neues Formular & Ablauf“ klicken.",
  "Current user": "Aktueller Benutzer",
  "Field selection is not available for bundles at this time.":
    "Die Feldauswahl ist für Bundles derzeit nicht verfügbar.",
